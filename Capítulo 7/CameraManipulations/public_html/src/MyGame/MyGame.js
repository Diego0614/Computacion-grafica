...
MyGame.prototype.update = function () {
    var zoomDelta = 0.05;
    var msg = "L/R: Left or Right Minion;  N/M: zoom in and out ";
    ...
    if (gEngine.Input.isKeyClicked(gEngine.Input.keys.P)) {
        ...
        this.mChoice = 'P';
        this.mCamera.panTo(this.mPortal.getXform().getXPos(), this.mPortal.getXform().getYPos());
    }
